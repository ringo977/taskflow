const it = {
  ...
  calFeed: 'Feed calendario', calFeedDesc: 'Iscriviti alle tue scadenze in Google/Outlook Calendar',
  calFeedShow: 'Mostra il mio link', calFeedCopy: 'Copia link', calFeedCopied: 'Copiato!',
  calFeedRotate: 'Rigenera link', calFeedError: 'Impossibile generare il link calendario.',
  calFeedHint: 'Incollalo in Google Calendar → Altri calendari → Da URL, oppure in Outlook → Aggiungi calendario → Da Internet. Sola lettura, si aggiorna da solo.',
  ...
  milestone: 'Milestone', selectMilestone: 'Assegna a MS…', noMs: '—',
  milestones: 'Milestone', addMilestone: 'Aggiungi MS', noMilestones: 'Nessuna milestone',
  msCode: 'Codice (es. MS1)', msName: 'Nome', msDescription: 'Mezzo di verifica',
  msOwner: 'Responsabile', msTargetDate: 'Data target', msWorkpackage: 'WP (opzionale)',
  msStatusDraft: 'Bozza', msStatusPending: 'In attesa', msStatusAchieved: 'Raggiunta', msStatusMissed: 'Mancata',
  msProgress: 'Avanzamento', msTasks: 'Task collegati', msMeansOfVerification: 'Mezzo di verifica',
  editMs: 'Modifica', deleteMs: 'Elimina MS',
  migrationHelperTitle: 'Migrazione milestone', migrationHelperCount: 'task da convertire',
  migrationHelperDesc: 'Questi task avevano il vecchio flag milestone. Crea milestone strutturate e ri-associa i task.',
  dismiss: 'Chiudi',
  ...
  reportMilestones: 'Avanzamento milestone',

  // ── Dashboard (project) ─────────────────────────────────────
  dashboard: 'Dashboard',
  dashDetails: 'Dettagli e impostazioni',
