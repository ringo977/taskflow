...
export default function IconSidebar({ active, onNav, currentUser, onLogout, lang, setLang, theme, setTheme, orgs, activeOrgId, onSwitchOrg, onAddOrg, dbStatus }) {
  ...
  const NAV = [
    ...
    { id: 'trash',      label: t.trash ?? 'Trash', icon: <svg width="18" height="18" viewBox="0 0 16 16" fill="none"><path d="M3 4h10l-.8 9.2a1 1 0 01-1 .8H4.8a1 1 0 01-1-.8L3 4z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/><path d="M2 4h12" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/><path d="M6 2h4" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg> },
  ]
