# Brief tecnico — Layer "Project Supervision" per TaskFlow (v2)
...
- Deadlines Cockpit
- estrazione selector condivisi dal core/dashboard
...
2. Implementare `project_deliverables` + `project_deliverable_tasks` + CRUD base + tabella register.
3. Estrarre selector condivisi da dashboard/core per overdue, due soon, ownerless e viste aggregate.
