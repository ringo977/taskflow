const en = {
  ...
  calFeed: 'Calendar feed', calFeedDesc: 'Subscribe to your deadlines in Google/Outlook Calendar',
  calFeedShow: 'Show my link', calFeedCopy: 'Copy link', calFeedCopied: 'Copied!',
  calFeedRotate: 'Regenerate link', calFeedError: 'Could not generate the calendar link.',
  calFeedHint: 'Paste it into Google Calendar → Other calendars → From URL, or Outlook → Add calendar → From Internet. Read-only, updates automatically.',
  ...
  hidden: 'hidden',
  statusDistribution: 'Status distribution', byPriority: 'By priority', upcomingMilestones: 'Upcoming milestones',
